        ...
        <div className="p-6 mb-6 border bg-indigo-900/30 rounded-xl border-purple-500/30">
          <AnimatePresence mode="wait">
            {!gameActive ? (
              ...
              >
                <div className="absolute inset-0 flex items-center justify-center rounded-full bg-gradient-to-r from-purple-500 to-blue-500">
    ...
    <div className="min-h-screen text-white bg-slate-900">
      ...
      <div className="p-4 bg-slate-800/50 backdrop-blur-sm">
        <div className="text-center">
          <h1 className="text-2xl font-bold capitalize"> lock in and tap </h1>
          <p className="text-sm font-medium text-gray-300">mini app</p>
        </div>
      </div>
